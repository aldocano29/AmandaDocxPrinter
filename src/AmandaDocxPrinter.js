...
var amanda_docx_printer = {
  ...
  docxSelector : function(dynamicAction){
    ...
    ajaxFunction = dynamicAction.attribute08;


    console.log("ITEMS: "+querycursor);
    var queryArray = querycursor.split(',');
    querycursor = '';

    queryArray.forEach(function(element) {
        console.log(element);
        querycursor = querycursor+$v(element)+'~'
    });
